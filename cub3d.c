...
{
	mlx->tex.texture_1 = mlx_xpm_file_to_image(mlx->window.mlx_ptr, mlx->path.south_path, &mlx->tex.width_1, &mlx->tex.height_1);
	...
	mlx->tex.texture_3 = mlx_xpm_file_to_image(mlx->window.mlx_ptr, mlx->path.west_path, &mlx->tex.width_3, &mlx->tex.height_3);
	mlx->tex.texture_data_3 = (int *)mlx_get_data_addr(mlx->tex.texture_3, &mlx->img.bpp, &mlx->img.size_l, &mlx->img.endian);
	mlx->tex.texture_4 = mlx_xpm_file_to_image(mlx->window.mlx_ptr, mlx->path.east_path, &mlx->tex.width_4, &mlx->tex.height_4);
